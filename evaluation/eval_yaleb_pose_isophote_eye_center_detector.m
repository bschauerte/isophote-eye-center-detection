function eval_yaleb_pose_isophote_eye_center_detector
  ...
  nposes=9;
  nsubjects=10;
  data_yaleb_nsamples=nposes * nsubjects;
  ...
  for subject=1:nsubjects
    ...
    for pose=0:(nposes-1)
      ...
      % load image
      img=imread_yale(subject,pose,NaN,NaN,data_yaleb_path);
      
      % read annotations
      [elx,ely,erx,ery,~,~]=read_yale_eye(subject,pose,NaN,NaN,data_yaleb_path);
      el=[elx ely];
      er=[erx ery];
